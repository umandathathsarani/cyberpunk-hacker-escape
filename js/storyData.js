const storyNodes = [
  {
    ...
    options: [
      { text: "Search the server racks", nextText: 2 },
      { text: "Try the locked door", nextText: 3 },
      { text: "Inspect the glowing terminal in the corner", nextText: 6 }
    ]
  },
  {
    id: 2,
    ...
    options: [
      { text: "Take the keycard and approach the door", setState: { keycard: true }, nextText: 3 },
      { text: "Take the keycard and inspect the glowing terminal", setState: { keycard: true }, nextText: 6 }
    ]
  },
  {
    id: 3,
    ...
    options: [
      { text: "Swipe the SECURITY KEYCARD", requiredState: (currentState) => currentState.keycard, nextText: 4 },
      { text: "Try to hack the door manually", minigame: { winNode: 4, loseNode: 5 } }
    ]
  },
  {
    id: 4,
    ...
    options: [
      { text: "Enter the Security Office", nextText: 7 },
      { text: "Proceed to the Mainframe Core", nextText: 8 },
      { text: "Pry open the Ventilation Grate", nextText: 11 },
      { text: "Enter the restricted AI Lab", nextText: 18 }
    ]
  },
  {
    id: 5,
    ...
    options: [
      { text: "REBOOT_SYSTEM.exe (Restart)", nextText: -1 }
    ]
  },
  {
    id: 6,
    ...
    options: [
      { text: "Attempt a brute-force attack", minigame: { winNode: 4, loseNode: 5 } },
      { text: "Step away and search the server racks instead", nextText: 2 }
    ]
  },
  {
    id: 7,
    ...
    options: [
      { text: "Take the drive and head to the Mainframe Core", setState: { malware: true }, nextText: 8 },
      { text: "Pry open the ceiling vent in the office", setState: { malware: true }, nextText: 11 }
    ]
  },
  {
    id: 8,
    ...
    options: [
      { text: "Inject the MALWARE DECRYPTOR into the core port", requiredState: (currentState) => currentState.malware, nextText: 9 },
      { text: "Let the AI ally bypass the firewalls for you", requiredState: (currentState) => currentState.ai_ally, nextText: 9 },
      { text: "Try to bypass the final firewalls using brute force", minigame: { winNode: 9, loseNode: 10 } }
    ]
  },
  {
    id: 9,
    ...
    options: [
      { text: "Prepare for a confrontation", nextText: 12 }
    ]
  },
  {
    id: 10,
  ...
  },
  {
    ...
    options: [
      { text: "Drop down into the Security Office", setState: { emp_grenade: true }, nextText: 7 },
      { text: "Drop down near the Mainframe Core", setState: { emp_grenade: true }, nextText: 8 }
    ]
  },
  {
    id: 12,
    ...
    options: [
      { text: "Throw the EMP GRENADE", requiredState: (currentState) => currentState.emp_grenade, nextText: 13 },
      { text: "Command your AI ally to overload his cybernetics", requiredState: (currentState) => currentState.ai_ally, nextText: 17 },
      { text: "Try to sneak around him in the dark", nextText: 14 },
      { text: "Draw your stun baton and fight him head-on", nextText: 15 }
    ]
  },
  {
    id: 13,
    ...
    options: [
      { text: "Run to the extraction chopper", nextText: 16 }
    ]
  },
  {
    id: 14,
  ...
  },
  {
    ...
    options: [
      { text: "PLAY_AGAIN.exe (Restart)", nextText: -1 }
    ]
  },
  {
    id: 17,
  ...
  },
  {
    ...
    options: [
      { text: "Accept the upload (Gain AI Ally)", setState: { ai_ally: true }, nextText: 19 },
      { text: "Refuse and smash the terminal", nextText: 20 }
    ]
  },
  {
    id: 19,
    ...
    options: [
      { text: "Return to the main corridor", nextText: 4 }
    ]
  },
  {
    id: 20,
